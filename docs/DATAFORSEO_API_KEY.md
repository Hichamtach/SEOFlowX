...
SEOFlowX uses [DataForSEO](https://dataforseo.com/?aff=313166) to fetch SEO data. It's a pay-as-you-go third-party service unaffiliated with SEOFlowX. You need an API key to connect SEOFlowX to it.

New DataForSEO accounts include $1 of free credit to test with, and the minimum top-up is $50.

## Get your API key

1. Go to [DataForSEO API Access](https://app.dataforseo.com/api-access?aff=313166) (create an account if you don't have one).
