...
const SUPPORT_EMAIL = "hichamtach@gmail.com";
...
const SKILLS_INSTALL = `npx skills add Hichamtach/SEOFlowX`;
const ALL_SKILLS_INSTALL = `npx skills add Hichamtach/SEOFlowX --skill '*'`;
const CLAUDE_CODE_SKILLS_INSTALL = `npx skills add Hichamtach/SEOFlowX --skill '*' --agent claude-code`;
const CODEX_SKILLS_INSTALL = `npx skills add Hichamtach/SEOFlowX --skill '*' --agent codex`;
const SKILLS_MANUAL_INSTALL = `git clone https://github.com/Hichamtach/SEOFlowX.git
    ...
    <div className="h-full overflow-auto bg-base-100 px-4 py-12 md:px-6 md:py-16 pb-24 md:pb-12">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 text-sm text-base-content/70 leading-relaxed">
          Connect your AI agent to SEOFlowX. Run keyword research, SERP
        ...
        <section className="mt-8">
          ...
          <p className="mt-2.5 text-xs text-base-content/55 leading-relaxed">
            Paste this into any MCP client. This URL points at the SEOFlowX
            instance you are using now, whether hosted, self-hosted, or local.
            Sign in with SEOFlowX when prompted.
          </p>
        </section>
        ...
        <section className="mt-10">
          ...
          <div className="mt-4 divide-y divide-base-300 overflow-hidden rounded-lg border border-base-300 bg-base-200">
            ...
            >
              ...
              <CodeBlock
                code={`claude mcp add --transport http --scope user seoflowx ${mcpUrl}`}
                onCopy={() =>
            ...
            >
              <ol className="ml-5 list-decimal space-y-1.5 text-sm text-base-content/70 leading-relaxed">
                ...
                <li>Approve the SEOFlowX login when prompted.</li>
                <li>
                  Optional: after SEOFlowX connects, click{" "}
                  <span className="font-medium text-base-content">
                    Configure
                  </span>
                  , then choose{" "}
            ...
            >
              ...
              <CodeBlock
                code={`codex mcp add seoflowx --url ${mcpUrl}`}
                onCopy={() =>
                  captureClientEvent("mcp:setup_command_copy", {
                    agent: "codex",
                  })
        ...
        <section className="mt-12">
          <h2 className="text-base font-semibold">SEOFlowX Skills</h2>
          <p className="mt-1.5 text-sm text-base-content/70 leading-relaxed">
            ...
            call your SEOFlowX MCP tools when live SERP, keyword, backlink, or
          ...
          <div className="mt-4 divide-y divide-base-300 overflow-hidden rounded-lg border border-base-300 bg-base-200">
            ...
            >
              ...
              <p className="text-sm text-base-content/70">
                You can also auto-accept each SEOFlowX skill:
              </p>
            ...
            {[
              {
                ...
                description:
                  "Ask questions and run research without leaving SEOFlowX",
              },
              {
        ...
        <p className="mt-12 text-xs text-base-content/55 leading-relaxed">
          Have feedback? Reach out via email to{" "}
