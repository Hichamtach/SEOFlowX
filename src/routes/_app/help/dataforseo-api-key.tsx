...
const DATAFORSEO_API_ACCESS_URL =
  "https://app.dataforseo.com/api-access?aff=313166";
        ...
        <div className="card bg-base-100 border border-base-300">
          <div className="card-body gap-3">
            ...
            <p className="text-sm text-base-content/70">
              SEOFlowX needs the <code>DATAFORSEO_API_KEY</code> secret before
