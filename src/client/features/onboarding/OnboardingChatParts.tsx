    ...
    <div className="flex gap-3">
      ...
      <div className="min-w-0 flex-1 space-y-3 pt-0.5 text-sm">
        <div className="space-y-3 text-base-content/80">
          <p>Hey, I’m Sam — welcome to SEOFlowX.</p>
          <p>
            To get full access to SEOFlowX, you need to upgrade to the paid
            plan. But, I’m here if you have any questions.
          </p>
          <p>
            You can email{" "}
            <a href="mailto:hichamtach@gmail.com" className="link link-primary">
              hichamtach@gmail.com
            </a>{" "}
    ...
    <div className="flex-shrink-0 border-t border-base-300 px-5 py-4">
      <div className="mx-auto w-full max-w-2xl rounded-box border border-primary/30 bg-primary/5 p-4 text-center">
        ...
        <p className="mx-auto mt-1 max-w-md text-xs text-base-content/70">
          Upgrade to keep working with Sam and unlock the full SEOFlowX app.
        </p>
        <button
          type="button"
...
export function ChatComposer({
  busy,
  onSend,
  placeholder = "Ask Sam about your strategy or SEOFlowX…",
}: {
  busy: boolean;
