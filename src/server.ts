...
import { handleSelfHostedSeoFlowXMcpRequest } from "@/server/mcp/transport";
...
const seoFlowXOAuthProvider = createSeoFlowXOAuthProvider(appFetch);
...
function handleFetch(
  ...
  if (isHostedAuthMode(authMode)) {
    ...
    return seoFlowXOAuthProvider.fetch(
      publicRequest,
      env as SeoFlowXOAuthEnv,
      ctx,
    );
  }
  ...
  if (
    ...
    return handleSelfHostedSeoFlowXMcpRequest(
      publicRequest,
      authMode,
      env,
      ctx,
