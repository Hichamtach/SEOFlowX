...
describe("normalizeBacklinksTarget", () => {
  ...
  it("trims trailing slashes from non-root page URLs", () => {
    expect(
      normalizeBacklinksTarget("https://github.com/Hichamtach/SEOFlowX/"),
    ).toEqual({
      apiTarget: "https://github.com/Hichamtach/SEOFlowX",
      displayTarget: "https://github.com/Hichamtach/SEOFlowX",
      scope: "page",
    });
  });
