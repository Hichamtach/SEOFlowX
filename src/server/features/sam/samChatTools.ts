 ...
 * free site-reading tools. Every tool the SEOFlowX MCP server exposes is
...
export function buildSamMcpTools(
  ...
  return {
    ...
    get_product_info: tool({
      description:
        "The SEOFlowX fact sheet: what the product does, plans/pricing, credit costs, integrations, MCP setup. Call before answering questions about SEOFlowX itself. Uses no credits.",
      inputSchema: z.object({}),
      execute: () => Promise.resolve({ factSheet: seoFlowXFactSheet }),
    }),
