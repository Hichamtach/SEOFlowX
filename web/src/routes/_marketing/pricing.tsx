 ...
 * ------------------------------------------------------------------ */
const MARKUP = 1.28; // SEOFlowX's flat 28% premium over raw DataForSEO cost
...
// Raw DataForSEO per-call cost in USD (NOT including SEOFlowX's markup).
const RAW_COST_USD = {
  ...
  return (
    <article className="mx-auto max-w-4xl">
      ...
      <p className="mt-4 max-w-2xl text-base leading-7 text-[var(--color-brand-muted)]">
        Other SEO tools are too expensive. SEOFlowX grows with you.
      </p>
      ...
      <section className="mt-10 border-y border-[var(--color-border-subtle)] py-8">
        ...
        <div className="mt-6 flex items-center gap-4">
          <a
            href="https://app.seoflowx.com/sign-up"
        ...
        <dl className="mt-5 divide-y divide-[var(--color-border-subtle)]">
          ...
          <div className="py-4 first:pt-0 last:pb-0">
            ...
            <dd className="mt-1.5 text-sm leading-6 text-[var(--color-brand-muted)]">
              ...
              need an active subscription in order to use SEOFlowX.
            </dd>
          </div>
        </dl>
      </section>
