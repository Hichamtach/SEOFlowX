...
export const featurePages = {
  keywordResearch: {
    ...
    imageAlt: "SEOFlowX keyword research dashboard",
    imageSrc:
    ...
    faqs: [
      {
        question: "What is SEOFlowX keyword research best for?",
        answer:
          "SEOFlowX is best for finding SEO keyword ideas, checking demand and difficulty, and turning those ideas into saved keywords you can revisit.",
      },
      {
        question: "Can I use SEOFlowX as a free keyword research tool?",
        answer:
          "Not unlimited: quality keyword data costs money everywhere, which is why the big SEO suites run $100/month and up. SEOFlowX is the most affordable option; you can start for free, and paid plans start at $10/month with usage credits included. It's also open source, so you can self-host with your own DataForSEO account.",
      },
      {
        question: "Does SEOFlowX show live search results?",
        answer:
  ...
  siteAudit: {
    ...
    imageAlt: "SEOFlowX site audit report",
    imageSrc:
    ...
    faqs: [
      {
        question: "What does the SEOFlowX site audit tool check?",
        answer:
      ...
      {
        question: "Is SEOFlowX a free SEO audit tool?",
        answer:
          "For smaller sites, yes: the free plan includes site audits up to 50 pages per crawl. Larger crawls need a paid plan, starting at $10/month. SEOFlowX is also open source and self-hostable.",
      },
      {
        question: "Who should use SEOFlowX Site Audit?",
        answer:
  ...
  backlinkChecker: {
    ...
    imageAlt: "SEOFlowX backlinks report",
    imageSrc:
    ...
    related: [
      ...
      { label: "Domain Overview", href: "/features/domain-overview" },
      { label: "SEOFlowX MCP", href: "/features/mcp" },
    ],
    faqs: [
      {
      ...
      {
        question: "Can I check competitor backlinks in SEOFlowX?",
        answer:
  ...
  domainOverview: {
    ...
    imageAlt: "SEOFlowX domain overview",
    imageSrc:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "SEOFlowX covers the core of the same report (estimated traffic, organic keywords, top keywords, and top pages) without a triple-digit monthly seat. SEOFlowX is open source, so you can self-host it, and the managed app is $10/month and includes usage credits.",
      },
      {
        question: "Can SEOFlowX help with competitor keyword analysis?",
        answer:
  ...
  rankTracking: {
    ...
    imageAlt: "SEOFlowX rank tracking table",
    imageSrc:
    ...
    differentiators: [
      ...
      "SEOFlowX can expose ranking data to AI agents through MCP.",
    ],
    related: [
      { label: "Keyword Clustering", href: "/docs/skills/keyword-clustering" },
      {
    ...
    faqs: [
      ...
      {
        question: "Does SEOFlowX track mobile and desktop rankings?",
        answer:
  ...
  savedKeywords: {
    ...
    imageAlt: "SEOFlowX saved keywords list",
    imageSrc:
  ...
  aiBrandVisibility: {
    ...
    imageAlt: "SEOFlowX AI brand visibility report",
    imageSrc:
    ...
    differentiators: [
      ...
      "SEOFlowX helps teams connect AI mention and citation research to concrete SEO planning.",
    ],
    related: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Traditional SEO focuses on rankings and pages. SEOFlowX's AI visibility workflow looks at mentions, cited pages, related prompts, and platform-level metrics from supported AI-search sources.",
      },
      {
  ...
  aiSearchPrompts: {
    ...
    imageAlt: "SEOFlowX prompt explorer",
    imageSrc:
    ...
    differentiators: [
      ...
      "SEOFlowX treats AI search as a research layer, not a replacement for SEO fundamentals.",
      "SEOFlowX MCP exposes keyword, SERP, domain, backlink, saved keyword, and rank-tracking tools to AI agents.",
    ],
    related: [
