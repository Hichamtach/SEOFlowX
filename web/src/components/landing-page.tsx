...
const SIGNUP_URL = "https://app.seoflowx.com/sign-up";
const PRODUCT_HUNT_URL =
  "https://www.producthunt.com/products/seoflowx?launch=seoflowx";
const GITHUB_URL = "https://github.com/Hichamtach/SEOFlowX";
...
const TESTIMONIALS: Testimonial[] = [
  {
    quote:
      "All of the value, none of the bloat. SEOFlowX is a no-brainer compared to the expensive alternatives!",
    name: "Fed",
    initial: "F",
    handle: "@foliofed",
  ...
  {
    quote:
      "I've been using SEOFlowX for the past 3 months, Ben keeps launching features to make it the best. I use it every day to find where my competitors are ranking.",
    name: "Samik",
    initial: "S",
    handle: "Subclip",
  ...
  {
    quote:
      "It's so straightforward and incredibly easy to get started. SEOFlowX gives you the complete setup, stripped of all the fluff that you get elsewhere.",
    name: "Tom Raine",
    initial: "T",
    handle: "LinkedIn",
  ...
  return (
    <section className="itc-hero">
      <Container>
        ...
        >
          Without quality data, AI gives generic advice. SEOFlowX is built for
...
function DemoVideo() {
  return (
    <video
      ...
      playsInline
      preload="metadata"
      aria-label="SEOFlowX product demo: running keyword research"
    >
      <source src="/demo.mp4" type="video/mp4" />
      <img
        src="/demo-poster.webp"
        alt="SEOFlowX keyword research dashboard"
        width={1280}
        height={966}
        loading="lazy"
        decoding="async"
    ...
    <section className="itc-section itc-section-demo">
      <Container>
        <div className="itc-narrow">
          <h2 className="itc-display-lg">See SEOFlowX in action</h2>
        ...
        <div className="itc-mcp-grid">
          <div>
            ...
            <p className="itc-body-lg itc-muted" style={{ margin: "20px 0 0" }}>
              ...
              performance, then you can review the work in SEOFlowX.
            </p>
          ...
          <div className="itc-terminal">
            <div className="itc-terminal-bar">
              ...
              <span className="itc-terminal-label">claude · seoflowx mcp</span>
            </div>
            <pre>
              <code>
                <span className="t-orange">›</span> find and cluster keywords
                for <span className="t-bright">seoflowx.com</span>
                {"\n\n"}
                <span className="t-dim">
                  ⏺ seoflowx.keyword_research(seed: &quot;open source seo&quot;)
                </span>
                {"\n"}
                {"  "}keyword{"                      "}volume{"     "}kd{"\n"}
                {"  "}open source seo{"              "}
                ...
                <span className="t-bright">app.seoflowx.com/keywords</span>
              </code>
            </pre>
          </div>
        </div>
      ...
      <Container>
        <div className="itc-narrow">
          ...
          <p className="itc-subhead itc-muted" style={{ margin: "20px 0 0" }}>
            ...
            tool from scratch, tell them to build on top of SEOFlowX.
          </p>
        </div>
