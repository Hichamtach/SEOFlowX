---
title: "Self-Hosting SEOFlowX"
description: "Run SEOFlowX yourself with Docker or Cloudflare, bring your own DataForSEO API key, and pay only for what you use."
---

SEOFlowX is free and open source. Self-hosting means the app costs $0. You bring your own DataForSEO API key and pay DataForSEO directly for API usage.
...
SEOFlowX uses [DataForSEO](https://dataforseo.com/?aff=313166) to fetch SEO data. DataForSEO is a paid third-party service unaffiliated with SEOFlowX. You need an API key to connect SEOFlowX to it.

1. Go to [DataForSEO API Access](https://app.dataforseo.com/api-access?aff=313166).
...
Search Console is optional and works in self-hosted deployments using your own Google OAuth client. It takes about 10 minutes of one-time setup. See the [Google Search Console guide on GitHub](https://github.com/Hichamtach/SEOFlowX/blob/main/docs/SELF_HOSTING_GOOGLE_SEARCH_CONSOLE.md).
