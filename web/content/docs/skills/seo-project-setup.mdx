...
- Recommend the next SEOFlowX Agent Skill to run.
...
Set up [SEOFlowX MCP](/docs/mcp) so your agent can confirm the right SEOFlowX project and use live SEO data in later workflows.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Project Setup skill](https://github.com/Hichamtach/SEOFlowX/tree/main/.agents/skills/seo-project-setup)
