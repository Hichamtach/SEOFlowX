---
title: "SEOFlowX Agent Skills"
description: "Add SEOFlowX Agent Skills to Claude Code, Codex, or another AI agent so it can run repeatable SEO workflows with live SEOFlowX data."
---

SEOFlowX Agent Skills let you hand repeatable SEO workflows to your AI agent.
...
You stay in charge of strategy. Your agent uses SEOFlowX data and the skill instructions to return a recommendation, plan, or shortlist.

## Set up SEOFlowX Agent Skills

1. [Set up SEOFlowX MCP](/docs/mcp).
2. [Set up SEOFlowX Agent Skills](/docs/skills/setup).

MCP connects your agent to SEOFlowX data. Skills tell your agent which SEO workflow to run.
...
SEOFlowX uses the same `SKILL.md` pattern supported by modern AI agents. To learn how skills work in your agent, read:
