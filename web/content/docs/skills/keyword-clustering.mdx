...
Set up [SEOFlowX MCP](/docs/mcp) so your agent can read saved keywords, inspect SERPs, and use SEOFlowX project context while clustering.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Clustering skill](https://github.com/Hichamtach/SEOFlowX/tree/main/.agents/skills/keyword-clustering)
