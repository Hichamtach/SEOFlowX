    ...
    <SiteLayout>
      <main className="main">
        ...
        <p>
          ...
          SEOFlowX. The site has no accounts, forms, purchases, or
          user-submitted content. Privacy questions and requests can be sent to{" "}
          <a href="mailto:ben@seoflowx.com">ben@seoflowx.com</a>.
        </p>
        ...
        <p>
          ...
          understand traffic in the analytics product many SEOFlowX users use.
