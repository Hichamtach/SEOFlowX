---
name: seoflowx-review-web-content
description: Write and review content for the SEOFlowX website (web/) — blog posts, guides, feature pages, FAQs. Distills the philosophy for on-brand, useful, accurate content. Use whenever adding or editing user-facing prose in web/content or web/src.
metadata:
  internal: true
---

# SEOFlowX Web Content
...
1. **Traceable truth.** Every capability claim, price, and screenshot is verifiable against the code, the fact sheet (`src/server/features/onboarding/seoflowx-fact-sheet.md`), or the live product. If you can't point to where it's true, it doesn't ship.
...
3. **Honest pricing, with its reasoning.** Quality SEO data is expensive everywhere — that's why the big suites run $100/month and up. SEOFlowX is the affordable option: $10/month, free to start. Never simply "free."
...
- If a reader trusted every claim and screenshot, then opened SEOFlowX right now, where would reality not match?
